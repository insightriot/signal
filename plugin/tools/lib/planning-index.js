// tools/lib/planning-index.js — the auto-generated `/sig:docs-index` generator
// (M5.E3.S2 / FR3).
//
...
const INDEX_AUTOGEN_MARKER = 'Auto-generated by `/sig:docs-index`';
 ...
 * writer can't lost-update the INDEX. The standalone `/sig:docs-index` + `/sig:ship`
