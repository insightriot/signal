...
**Computed:** 2026-09-08 · **Commit:** `ed391ee` · **Corpus:** 23 `commands/*.md` files
...
| | count | share |
|---|---:|---:|
| Directive lines | **594** | 100% |
| …naming a real `tools/lib` export | 107 | 18.0% |
| …writing a named artifact | 18 | 3.0% |
| **Trace-measurable (either)** | **125** | **21.0%** |
| **No observable trace** | **469** | **79.0%** |

### What the remainder is, stated plainly

The 469 directives with no observable trace are **unmeasured, not passing.**
