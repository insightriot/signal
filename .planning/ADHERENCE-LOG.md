...
**Computed:** 2026-09-04 · **Commit:** `0daef41` · **Corpus:** 22 `commands/*.md` files
...
| | count | share |
|---|---:|---:|
| Directive lines | **575** | 100% |
| …naming a real `tools/lib` export | 105 | 18.3% |
| …writing a named artifact | 18 | 3.1% |
| **Trace-measurable (either)** | **123** | **21.4%** |
| **No observable trace** | **452** | **78.6%** |

### What the remainder is, stated plainly

The 452 directives with no observable trace are **unmeasured, not passing.**
