...
**Computed:** 2026-09-04 · **Commit:** `6f4f5d7` · **Corpus:** 22 `commands/*.md` files
...
| | count | share |
|---|---:|---:|
| Directive lines | **573** | 100% |
| …naming a real `tools/lib` export | 105 | 18.3% |
| …writing a named artifact | 18 | 3.1% |
| **Trace-measurable (either)** | **123** | **21.5%** |
| **No observable trace** | **450** | **78.5%** |

### What the remainder is, stated plainly

The 450 directives with no observable trace are **unmeasured, not passing.**
