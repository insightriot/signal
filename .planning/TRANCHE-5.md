# Tranche 5 — Rundown v2 Integrations

> **Roadmap note (2026-04-26):** This was originally TRANCHE-4. It moved to TRANCHE-5 when `/sig:init` (brownfield onboarding) was promoted to TRANCHE-4 — see `.planning/DECISIONS.md` (2026-04-26 — "Roadmap reorder: brownfield onboarding promoted to TRANCHE-4"). The v2-ports work itself is unchanged; only its position in the queue moved.
...
**Blocked by:** Tranche 4 complete (brownfield onboarding shipped) + v1 shipping to actual users for at least a few weeks. Without usage signal, v2 additions are speculative.
...
### 5a. Upstream phases — IDEATE / VALIDATE / STRATEGIZE
...
### 5b. COMPOUND phase (memory layer)
