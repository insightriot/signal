...
**Active: none — M5.E18 closed 2026-08-04.** Next queued: **M5.E15** — the control arm, made real (`B55`). **The queue is `.planning/BACKLOG.md`, not this file** (`D-M5E18-1`): when work is filed, only BACKLOG gets edited, so read the ordering there.
